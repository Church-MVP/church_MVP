            ...
            <div class="card-grid">
                ...
                <div class="card" style="overflow: hidden; transition: transform 0.3s, box-shadow 0.3s;">
                    ...
                    <div class="card-content">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem;">
                                ...
                                <span style="color: #666;">
                                    of $<?php echo number_format($campaign['goal_amount'], 0); ?> goal
                                </span>
                            </div>
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 0.25rem;">
                                ...
                                <small style="color: #666;">
                                    <i class="fas fa-users"></i> <?php echo number_format($campaign['donor_count']); ?> donors
                                </small>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php elseif ($campaign['show_donor_count']): ?>
                        <div style="margin-bottom: 1rem;">
                            <span style="color: #28a745; font-weight: bold;">
                                $<?php echo number_format($campaign['current_amount'], 0); ?> raised
                            </span>
                        ...
                        <!-- Donate Button -->
                        <a href="campaign.php?slug=<?php echo htmlspecialchars($campaign['slug']); ?>" 
                    ...
                    <div class="card-content">
                        ...
                        <div style="margin-bottom: 1rem;">
                            <div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem; font-size: 0.875rem;">
                                ...
                                <span style="color: #666;">
                                    of $<?php echo number_format($campaign['goal_amount'], 0); ?>
                                </span>
                            </div>
