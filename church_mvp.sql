...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2026 at 03:08 PM
...
INSERT INTO `admins` (`id`, `username`, `password`, `email`, `full_name`, `role`, `is_active`, `last_login`, `two_factor_secret`, `two_factor_enabled`, `two_factor_recovery_codes`, `created_by`, `created_at`) VALUES
(1, 'admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@church.com', 'System Administrator', 'super_admin', 1, '2026-01-30 11:45:53', NULL, 0, NULL, NULL, '2026-01-11 06:20:14'),
(4, 'johndoe', '$2y$10$QPNLtFSSJURQh6hkVWpdnuzFSkv0/mMInTYicdwiA6/tNWXK2ey3i', 'jdoe@example.com', 'John Doe', 'admin', 1, '2026-01-29 12:11:11', NULL, 0, NULL, 1, '2026-01-13 03:51:04');
...
(1, 5, 'John Doe', 'john.doe@email.com', 100.00, 'Tithe', 'Credit Card', NULL, NULL, '2026-01-11 06:20:14', 0, 0, NULL, 'completed'),
(2, 1, 'Jane Smith', 'jane.smith@email.com', 50.00, 'Building Fund', 'PayPal', NULL, NULL, '2026-01-11 06:20:14', 0, 0, NULL, 'completed'),
(3, 4, 'Anonymous', 'anonymous@church.com', 250.00, 'Missions', 'Cash', NULL, NULL, '2026-01-11 06:20:14', 0, 0, NULL, 'completed');
...
(3, 'Community Outreach', '2026-01-31', '09:00:00', 'City Center', 'Serving our community with food and love', NULL, '2026-01-11 06:20:14', '2026-01-21 14:48:59', '', '00:00:00', '', '', '');
